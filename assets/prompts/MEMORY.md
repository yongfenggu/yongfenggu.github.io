...
**2026.09.07**
实习｜我入职了 MindLab，担任算法研究员，主要研究 Agent 以及基模的 param-level Memory，和 RSI 相关。

秋招｜最近的秋招机会取得了阶段性的进展。推进得比较好的有：
• 华为的 AI infra 岗位
• OPPO 的 AI 算法研究员和模型研究员
希望 9 月份能至少拿下两个 offer。

毕业｜这边，我把实验做完了，最近在画图，不过图还没画完，希望接下来一周能把所有的图都画完。

生活｜上周一次练胸，一次游泳，健身计划正常推进。这周在自己练拳击，还挺好玩的。
